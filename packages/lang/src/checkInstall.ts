...
export default function checkInstall(): Promise<boolean> {
  console.log("Checking supercollider.js@lang install...");
...
If you already have it installed but it is in a non-standard location then edit .supercollider.yaml and specify the path to sclang there.
