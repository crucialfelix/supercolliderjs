...
/*
  Communicates with the SuperCollider API quark

  This allows nodejs code to call any supercollider function registered with API
  and get an async response or failure.
