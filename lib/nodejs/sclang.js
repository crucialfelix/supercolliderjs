      ...
      booting: [
        {
          ...
          fn: function() {
            ...
            // and collect potential compile errors
          }
        }
      ],
      compiling: [
        {
          ...
          fn: function() {
            ...
            // and collect potential startup errors
          }
        },
        {
...
SCLang.prototype.interpret =
  function(code, nowExecutingPath, asString, postErrors) {
    var deferred = Q.defer(),
        ...
        args = [guidString, scstring, nep, rras, pe].join(','),
        scode;
