interface OptionalServerOptions {
...
export interface SCServerOptions extends OptionalServerOptions {
  host: string;
  serverPort: string;
  protocol: string;
}
...
/**
 * ServerOptions for the Server class constructor
 */
export interface ServerArgs extends OptionalServerOptions {
  // TODO you can't do overwrite in an extends
  host?: string;
  serverPort?: string;
  protocol?: string;

  // TODO separate the interfaces
  debug?: boolean;
  echo?: boolean;
  stdin?: boolean;
  log?: Console;
...
export interface ServerOptions extends SCServerOptions {
  // ServerOptions for the Server class constructor
  // TODO separate the interfaces
  debug?: boolean;
  echo?: boolean;
 ...
 */
export const defaultServerOptions: SCServerOptions = {
  host: "127.0.0.1",
  serverPort: "57110",
  protocol: "udp",
